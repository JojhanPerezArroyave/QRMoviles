...
public class MainActivity extends AppCompatActivity {
    ...
    private void bindpreview(ProcessCameraProvider processCameraProvider) {
        ...
        ImageAnalysis imageAnalysis = new ImageAnalysis.Builder().setTargetResolution(new Size(1280, 720)).setBackpressureStrategy(
    ...
    public class MyImageAnalyzer implements ImageAnalysis.Analyzer {
        ...
        private void scanbarcode(ImageProxy image) {
            ...
            @SuppressLint({"UnsafeExperimentalUsageError", "UnsafeOptInUsageError"}) Image image1 = image.getImage();
            assert image1 != null;
